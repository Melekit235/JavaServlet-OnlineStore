...
import com.bsuir.verghel.basketball.model.dao.OrderItemDao;
import com.bsuir.verghel.basketball.model.entities.order.OrderItem;
import com.bsuir.verghel.basketball.model.entities.order.OrderItemsExtractor;
...
public class JdbcOrderItemDao implements OrderItemDao {
    ...
    /**
     * SQL query for find balls from database by order
     */
