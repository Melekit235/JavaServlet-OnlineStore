...
import com.bsuir.verghel.basketball.model.entities.order.OrdersExtractor;
...
public class JdbcOrderDao implements OrderDao {
     ...
     */
    private static final String ADD_ORDER2ITEM = "INSERT INTO order2item (orderId, ballId, quantity) " +
            "VALUES (?, ?, ?)";
    /**
        ...
        try {
            ...
            if (generatedKeys.next()) {
                ...
                for (OrderItem orderItem : order.getOrderItems()) {
                    addOrderItem(conn, orderId, orderItem.getBall().getId(), orderItem.getQuantity());
                }
     ...
     * @param ballId  id of ball to add
     ...
     */
    private void addOrderItem(Connection conn, Long orderId, Long ballId, int quantity) throws SQLException {
